...
public class Main {
	public static void main(String[] args) {
        ...
        Trader_list.add(new Traders("Bhargav", "pune"));
        Trader_list.add(new Traders("Lakshmi", "Indore"));
        Trader_list.add(new Traders("Sairam", "delhi"));
        Trader_list.add(new Traders("Asiya", "delhi"));
        Trader_list.add(new Traders("Ayusha", "Ahemadabad"));
        Trader_list.add(new Traders("Mahi", "pune"));
        ...
        List<Transaction> Trans_list = Arrays.asList(
                new Transaction(new Traders("Mahi", "Delhi"), 2012, 4500),
                new Transaction(new Traders("Ayusha", "Delhi"), 2011, 4800),
                new Transaction(new Traders("Lakshmi", "Indore"), 2011, 4400));
